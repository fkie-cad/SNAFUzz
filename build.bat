...
rem disable a bunch of security things as otherwise it will insert externals like '__chkstk'.
...
rem /GS- prevents security cookies which introduce 'length changing prefixes', which vtune complains about. Maybe it's not a big deal though ~3%.

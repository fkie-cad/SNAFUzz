...
clang -ffreestanding -MMD -mno-red-zone -g -std=c11 -target x86_64-unknown-windows -m64 -ferror-limit=1 -w -mavx src/uefi_bios.c -fms-extensions -c -o build/bios.obj

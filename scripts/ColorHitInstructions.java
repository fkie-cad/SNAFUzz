...
//
// This is based of the following repository: https://github.com/alephsecurity/general-research-tools/tree/master/ghidra_scripts/ColorInstructions
// See license above.
//
...
public class ColorHitInstructions  extends GhidraScript {
    
    private static final String FILTER_PATTERN = "(0x[0-9a-fA-F]{16})(.*)"; 
    ...
    protected void run() throws Exception {
        ...
        long min_address_offset = currentProgram.getMinAddress().getOffset();
        
        for (Address addr : listOfInstPtrToCollor) {
            //Check whether we are in the correct address space
            addr = addr.add(min_address_offset);
        ...
        setBackgroundColor(addresses, new Color(0xd3, 0xd3, 0xd3));
    ...
    private List<Address> getAddresses() {
        ...
        try {
            File file = askFile("Coverage File", "Choose file:");
